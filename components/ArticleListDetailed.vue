...
<template>
    <div>
        <div class=" sticky z-1 top-0">
            <div class=" py-2 bg-base-100 border-b border-stone-700/80 flex gap-2 items-center px-3 ">
        ...
        <div class="p-3 pt-12">
            <div class=" transition-all">
                ...
                <div v-if="isLoading" class=" px-3 z-0 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3  gap-12">
