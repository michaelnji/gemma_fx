...
<template>
    <div class=" px-3 container mx-auto max-w-5xl">
        <h1
            ...
            The best at providing <span
                class="bg-clip-text bg-gradient-to-t from-secondary/10 via-secondary/40 to-secondary">unbiased</span>
            forex
            articles
        </h1>
        <div class="grid grid-cols-1 mt-8 content-center md:grid-cols-3 gap-4 ">
            <div class=" bg-gradient-to-b from-stone-800/30 to-stone-900/90 p-6  border border-stone-900   flex  gap-4">
                <!-- <Icon name="ph:users-three-duotone" size="70" /> -->
                <div>
                    <h2 class="font-extrabold text-4xl lg:text-6xl font-acro">309.5K</h2>
            ...
            <div class=" bg-gradient-to-b from-stone-800/30 to-stone-900/90 p-6  border border-stone-900   flex  gap-4">
                ...
                <div>
                    <h2 class="font-extrabold text-4xl lg:text-6xl font-acro">5</h2>
            ...
            <div class=" bg-gradient-to-b from-stone-800/30 to-stone-900/90 p-6  border border-stone-900   flex  gap-4">
                ...
                <div>
                    <h2 class="font-extrabold text-4xl lg:text-6xl font-acro">4.2</h2>
